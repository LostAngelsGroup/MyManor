package com.lag.mymanor.core.world;
...
import com.lag.mymanor.magic.world.CrystalSandGen;
import com.lag.mymanor.magic.world.MagicFuelGen;
...
public class MGenerator implements IWorldGenerator{
	...
	private void generateOverworld(Random random, int chunkX, int chunkZ, World world) {
		...
		for(int i = 0; i < 4; i++){
			spawnOre(TBlocks.ore, i, world, random, chunkX, chunkZ, 20, 2, 3, 20, 100);
		}
		for(int i = 0; i < 6; i++){
