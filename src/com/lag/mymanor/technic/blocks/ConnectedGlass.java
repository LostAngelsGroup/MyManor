...
public class ConnectedGlass extends MyManorBlockContainer{

	public ConnectedGlass(String name) {
	...
	public IIcon getIcon(IBlockAccess iBlockAccess, int x, int y, int z, int side){
		Tileentity_ConnectedGlass s_glass = (Tileentity_ConnectedGlass)iBlockAccess.getTileEntity(x, y, z);
	...
	public boolean shouldSideBeRendered(IBlockAccess blockAccess, int x, int y, int z, int side){
        ...
        if (this == TBlocks.connectedGlass)
        {
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new Tileentity_ConnectedGlass();
	}
}
