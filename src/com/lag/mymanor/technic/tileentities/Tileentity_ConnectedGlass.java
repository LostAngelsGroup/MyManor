package com.lag.mymanor.technic.tileentities;
...
public class Tileentity_ConnectedGlass extends TileEntity{
	private byte[] textures = new byte[3]; 
	
	public Tileentity_ConnectedGlass(){
	...
	public void updateEntity(){
		...
		for(int i = 0; i < 3; i++){
			for(int j = 0; j < 3; j++){
				for(int k = 0; k < 3; k++){
					if(this.getWorldObj().getBlock(xCoord+i-1, yCoord+j-1, zCoord+k-1) == TBlocks.connectedGlass){
